...
<style>
body{
 background-image:url(https://i0.wp.com/images7.alphacoders.com/499/499934.png);
}
</style>
</head>
<body>
...
<a href="cliente.jsp" type="submit">Cadastrar</a>
 ...
 <c:forEach  var="linha" items="${lista}" >
    <tbody>
        <tr>
            ...
            <td><a href="editarCliente?codCliente=${linha.codCliente}"  class="btn btn-warning">Editar</a>
			<a href="excluirCliente?codCliente=${linha.codCliente}"  class="btn btn-danger"
