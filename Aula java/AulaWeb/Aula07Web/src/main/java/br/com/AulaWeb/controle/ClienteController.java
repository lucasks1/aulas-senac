...
public class ClienteController extends HttpServlet {
	...
	public void executar(HttpServletRequest request ,HttpServletResponse request,
			throws ServeletException, IOException{
		try {
			String url = request.getServelPatch();
			if(url.equals("cadastrarCliente")) {
