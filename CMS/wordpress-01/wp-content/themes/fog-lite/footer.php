                ...
                <div class="row relative mini-section-separator">
                    <div class="col-sm-6" id="footer-sidebar-1">
						  ...
						  <ul class="social-icon">
							<?php
							$social_icons_default=array('facebook'=>'www.facebook.com/','twitter'=>'twitter.com/','googlePlus'=>'mail.google.com','dribbble'=>'dribbble.com/','youtube'=>'http://youtube.com/','linkedin'=>'in.linkedin.com/');
                    ...
                    <div class="col-sm-6" id="footer-sidebar-3">
                    	<?php 
							...
							if(is_active_sidebar('footer-sidebar-3')){
								...
								echo '<p> © 2019 FOG Lite Developed By <a href="https://jannatqualitybacklinks.com/">jannatqualitybacklinks.com</a></p>';
							}
							else 
							{
								//dynamic_sidebar('footer-sidebar-3');
