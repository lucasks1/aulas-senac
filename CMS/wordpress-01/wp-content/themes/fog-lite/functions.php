...
if ( ! function_exists( 'wedding_photo_setup' ) ) :
	...
	function wedding_photo_setup() {
		 ...
		 */
		load_theme_textdomain( 'fog-lite', get_template_directory() . '/languages' );
	...
	$config = array(
		...
		'support_content'     => array(
			'first'  => array(
				...
				'button_link'  => esc_url( 'https://jannatqualitybacklinks.com/contact-and-support/' ),
				'is_button'    => true,
				'is_new_tab'   => true,
			),
		...
		'getting_started'     => array(
			'first' => array(
				...
				'button_link'         => 'https://jannatqualitybacklinks.com/fog-lite-pro-documentation/',
				'is_button'           => false,
