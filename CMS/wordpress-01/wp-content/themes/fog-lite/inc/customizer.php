...
function wedding_photo_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'wedding_team_title', array(
        'default'           => 'Our Team',
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( 'wedding_team_title', array(
        'label'   => 'Section Heading',
        'section' => 'teams_settings_section',
        'type'    => 'text',
    ) );

    $wp_customize->selective_refresh->add_partial( 'wedding_team_title', array(
        'selector'        => '.team4_title', // You can also select a css class
        'render_callback' => 'wedding_team_title',
    ) );
    ...
    $wp_customize->add_setting( 'wedding_tips_title', array(
        'default'           => 'Tips',
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( 'wedding_tips_title', array(
        'label'   => 'Section Title',
        'section' => 'photograph_settings_section',
        'type'    => 'text',
    ) );

    $wp_customize->selective_refresh->add_partial( 'wedding_tips_title', array(
        'selector'        => '.tips_title', // You can also select a css class
        'render_callback' => 'wedding_tips_title',
    ) );
    ...
    $wp_customize->add_setting( 'wedding_pricing_title', array(
        'default'           => 'Pricing',
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( 'wedding_pricing_title', array(
        'label'   => 'Section Heading',
        'section' => 'pricing_plan_settings_section',
        'type'    => 'text',
    ) );

    $wp_customize->selective_refresh->add_partial( 'wedding_pricing_title', array(
        'selector'        => '.pricing_title', // You can also select a css class
        'render_callback' => 'wedding_pricing_title',
    ) );
    ...
    $wp_customize->add_setting( 'wedding_service_title', array(
        'default'           => 'Services',
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( 'wedding_service_title', array(
        'label'   => 'Section Heading',
        'section' => 'features_settings_section',
        'type'    => 'text',
    ) );

    $wp_customize->selective_refresh->add_partial( 'wedding_service_title', array(
        'selector'        => '.service_title', // You can also select a css class
        'render_callback' => 'wedding_service_title',
    ) );
    ...
    $wp_customize->add_setting( 'wedding_contactus_formsubmit', array(
        'sanitize_callback' => 'wp_kses_post',
    ) );

    $wp_customize->add_control( 'wedding_contactus_formsubmit', array(
        'label'       => 'Add Shortcode',
        'description' => 'Install Fluent Form plugin for Conatct Form. Create form and paste here shortcode.',
    ...
    $wp_customize->add_setting( 'copyright_text_setting', array(
        'default'           => '(c) 2019 FOG Lite Developed By jannatqualitybacklinks.com',
        'sanitize_callback' => 'wp_kses_post',
    ) );
    ...
    // remove panel,section, and control
